...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
    ...
    public void onAttachedToWindow(RecyclerView view) {
        ...
        LogUtils.dTag(TAG, "onAttachedToWindow: ");
        //默认先这么设置
        ...
        if (isInScrollingContainer(view)) {
            ...
            if (isHandlingSlidingConflictsEnabled) {
                ...
                //不启用的话可以自行解决
                LogUtils.dTag(TAG, "isHandlingSlidingConflictsEnabled: false.");
            }
        }
    ...
    public void onMeasure(@NonNull RecyclerView.Recycler recycler, @NonNull RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        LogUtils.dTag(TAG, "onMeasure-originalWidthSize: " + widthSize +
                ",originalHeightSize: " + heightSize +
                ",diffWidth: " + diffWidth +
                ",diffHeight: " + diffHeight +
                ",mItemWidth: " + mItemWidth +
                ",mItemHeight: " + mItemHeight +
                ",mStartSnapRect:" + mStartSnapRect +
                ",mEndSnapRect:" + mEndSnapRect);
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        LogUtils.dTag(TAG, "onLayoutChildren: " + state.toString());
        ...
        LogUtils.dTag(TAG, "onLayoutChildren-pagerCount:" + pagerCount + ",mLayoutState.mAvailable: " + mLayoutState.mAvailable);
        ...
        LogUtils.dTag(TAG, "onLayoutChildren: childCount:" + getChildCount() + ",recycler.scrapList.size:" + recycler.getScrapList().size() + ",mLayoutState.replenishDelta:" + mLayoutState.replenishDelta);
    ...
    public Parcelable onSaveInstanceState() {
        LogUtils.dTag(TAG, "onSaveInstanceState: ");
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof SavedState) {
            ...
            requestLayout();
            LogUtils.dTag(TAG, "onRestoreInstanceState: loaded saved state");
        }
    }
...
//        mPagerChangedListener = null;
    ...
    private int scrollBy(int delta, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        LogUtils.dTag(TAG, "scrollBy -> before : childCount:" + getChildCount() +
                ",recycler.scrapList.size:" + recycler.getScrapList().size() + ",delta:" + delta);
        ...
        //回收view，此步骤在移动之后
        recycleViews(recycler);
        LogUtils.dTag(TAG, "scrollBy -> end : childCount:" + getChildCount() + ",recycler.scrapList.size:" + recycler.getScrapList().size() + ",delta:" + delta + ",scrolled:" + scrolled);
    ...
    private void recycleViewsFromStart(RecyclerView.Recycler recycler) {
        ...
        for (int i = childCount - 1; i >= 0; i--) {
            ...
            if (childAt != null) {
                ...
                LogUtils.dTag(TAG, "recycleViewsFromStart-removeAndRecycleViewAt: " + i + ", position: " + getPosition(childAt));
    ...
    private void recycleViewsFromEnd(RecyclerView.Recycler recycler) {
        ...
        for (int i = childCount - 1; i >= 0; i--) {
            ...
            if (childAt != null) {
                ...
                LogUtils.dTag(TAG, "recycleViewsFromEnd-removeAndRecycleViewAt: " + i + ", position: " + getPosition(childAt));
...
//                removeAndRecycleView(childAt, recycler);
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        LogUtils.dTag(TAG, "computeScrollOffset: " + scrollOffset);
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        LogUtils.dTag(TAG, "computeScrollExtent: " + scrollExtent);
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        LogUtils.dTag(TAG, "computeScrollRange: " + scrollRange);
        return scrollRange;
    }
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        LogUtils.dTag(TAG, "computeScrollVectorForPosition-firstSnapPosition: " + firstSnapPosition + ", targetPosition:" + targetPosition + ",mOrientation :" + mOrientation + ", direction:" + direction);
