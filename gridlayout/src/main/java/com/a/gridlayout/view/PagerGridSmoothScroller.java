...
class PagerGridSmoothScroller extends LinearSmoothScroller {
    ...
    protected void onTargetFound(View targetView, RecyclerView.State state, Action action) {
        ...
        if (layoutManager instanceof PagerGridLayoutManager) {
            ...
            LogUtils.dTag(TAG,
                    "onTargetFound-targetPosition:" + targetPosition +
                            ", dx:" + dx + ",dy:" + dy + ",time:" + time + ",isLayoutToEnd:" + isLayoutToEnd + ",snapRect:" + snapRect + ",targetRect:" + targetRect);
    ...
    protected float calculateSpeedPerPixel(DisplayMetrics displayMetrics) {
        ...
        LogUtils.dTag(TAG, "calculateSpeedPerPixel-speed: " + speed);
        return speed;
    }
    ...
    protected final int calculateTimeForScrolling(int dx) {
        ...
        LogUtils.dTag(TAG, "calculateTimeForScrolling-time: " + time);
        return time;
    }
