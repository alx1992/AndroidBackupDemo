...
class PagerGridSnapHelper extends SnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX, int velocityY) {
        ...
        switch (snapList.size()) {
            ...
            case 3:
                ...
                break;
            default:
                LogUtils.dTag(TAG, "findTargetSnapPosition-snapList.size: " + snapList.size());
                break;
        }
        LogUtils.dTag(TAG, "findTargetSnapPosition->forwardDirection:" + forwardDirection + ",targetPosition:" + targetPosition + ",velocityX: " + velocityX + ",velocityY: " + velocityY + ",scrollDistance:" + scrollDistance + ",snapList:" + snapList.size());
        ...
        if (layoutManager instanceof PagerGridLayoutManager) {
            ...
            switch (snapList.size()) {
                ...
                case 3:
                    ...
                    break;
                default:
                    LogUtils.dTag(TAG, "findSnapView wrong -> snapList.size: " + snapList.size());

                    break;
            }
            LogUtils.dTag(TAG, "findSnapView: position:" + (snapView != null ? layoutManager.getPosition(snapView) : RecyclerView.NO_POSITION) + ", snapList.size:" + snapList.size());
    ...
    public int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager, @NonNull View targetView) {
        ...
        if (layoutManager instanceof PagerGridLayoutManager) {
            ...
            LogUtils.dTag(TAG, "calculateDistanceToFinalSnap-targetView: " + targetPosition + ",snapDistance: " + Arrays.toString(snapDistance));
